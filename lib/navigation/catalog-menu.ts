    ...
    sections: [
      {
        ...
        href: "/women/new-in",
        order: 1,
        // The business-supplied leaf list and URLs are not yet approved.
        groups: [],
        visualCards: [],
      },
      {
    ...
    sections: [
      {
        ...
        groups: [
          {
            id: "fragrance-beauty.new-in.new-in",
            label: "NEW IN",
            order: 1,
            items: [
              ...
              { id: "fragrance-beauty.new-in.triscent-pour-homme-giftset", label: "TRISCENT POUR HOMME - GIFTSET", href: "/fragrance-beauty/new-in/triscent-pour-homme-giftset", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 9 },
              { id: "fragrance-beauty.new-in.wasim-akram-502-him-her-gift-set", label: "WASIM AKRAM 502 HIM & HER - GIFT SET", href: "/fragrance-beauty/new-in/wasim-akram-502-him-her-gift-set", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 10 },
              { id: "fragrance-beauty.new-in.lumiere", label: "LUMIERE", href: "/fragrance-beauty/new-in/lumiere", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 11 },
              { id: "fragrance-beauty.new-in.featured", label: "FEATURED", href: "/fragrance-beauty/new-in/featured", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 12 },
              { id: "fragrance-beauty.new-in.gourmet-series", label: "GOURMET SERIES", href: "/fragrance-beauty/new-in/gourmet-series", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 13 },
              { id: "fragrance-beauty.new-in.janan-fragrances", label: "JANAN FRAGRANCES", href: "/fragrance-beauty/new-in/janan-fragrances", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 14 },
              { id: "fragrance-beauty.new-in.extrait-series-cast-crew", label: "EXTRAIT SERIES - CAST & CREW", href: "/fragrance-beauty/new-in/extrait-series-cast-crew", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 15 },
              { id: "fragrance-beauty.new-in.valor-collection", label: "THE VALOR COLLECTION", href: "/fragrance-beauty/new-in/valor-collection", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 16 },
              { id: "fragrance-beauty.new-in.wasim-akram-series", label: "WASIM AKRAM SERIES", href: "/fragrance-beauty/new-in/wasim-akram-series", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 17 },
              { id: "fragrance-beauty.new-in.aroma-oil-diffusers", label: "AROMA OIL & DIFFUSERS", href: "/fragrance-beauty/new-in/aroma-oil-diffusers", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 18 },
              { id: "fragrance-beauty.new-in.air-fresheners", label: "AIR FRESHENERS", href: "/fragrance-beauty/new-in/air-fresheners", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 19 },
              { id: "fragrance-beauty.new-in.bakhoor", label: "BAKHOOR", href: "/fragrance-beauty/new-in/bakhoor", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 20 },
              { id: "fragrance-beauty.new-in.gift-sets", label: "GIFT SETS", href: "/fragrance-beauty/new-in/gift-sets", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 21 },
              { id: "fragrance-beauty.new-in.miniatures", label: "MINIATURES", href: "/fragrance-beauty/new-in/miniatures", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 22 },
              { id: "fragrance-beauty.new-in.continuous-spray-perfumes", label: "CONTINUOUS SPRAY PERFUMES", href: "/fragrance-beauty/new-in/continuous-spray-perfumes", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 23 },
            ],
          },
        ],
        visualCards: [],
        ...
        groups: [
          {
            ...
            items: [
              ...
              { id: "teens.new-in.kid-girls", label: "KID GIRLS", href: "/teens/new-in/kid-girls", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 3 },
              { id: "teens.new-in.kid-boys", label: "KID BOYS", href: "/teens/new-in/kid-boys", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 4 },
              { id: "teens.new-in.infant-girls", label: "INFANT GIRLS", href: "/teens/new-in/infant-girls", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 5 },
              { id: "teens.new-in.infant-boys", label: "INFANT BOYS", href: "/teens/new-in/infant-boys", image: null, badge: null, comingSoon: false, visibility: "visible", status: "active", order: 6 },
            ],
          },
        ],
        visualCards: [],
